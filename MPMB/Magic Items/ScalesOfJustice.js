...
/*  -INFORMATION-
	Subject:    The Silver Sword of Abadara
	Effect:     This script adds the Silver Sword of Abadara artifact
	Code by:	DissonanceTK
	Date:		2020-04-30 (sheet v13)
*/

var iFileName = "ScalesOfJustice.js";
RequiredSheetVersion("13.0.6");

MagicItemsList["scales of justice"] = {
	name : "Silver Sword of Abadara",
	sortname : "Sword, Scales of Justice",
	nameAlt : "Scales of Justice",
	source : ["HB", 0],
...
*/
	description : "The Scales of Justice is a Bastard sword (long sword rules but slightly bigger).  The blade is unpolished and flat, but does not stain, dull, or chip.  The grip is black leather that feels good but well used in the hand, and it does not become wet no matter the conditions (including under water).",
...
*/
	descriptionLong : "When attuned the blade grants the following powers: It is a +3 longsword. The wielder becomes proficient with it, even if they were not previously. The wielder is immune to Charm. The wielder gains the “Voice of Authority” Domain feature from the Order Domain. The wielder gains the “True Strike” cantrip, except it requires a Bonus Action, not a full action. Once per long rest, the user can mark a *deserving* target for Justice.  Any hits against that target do an additional 1d6 Psychic damage.  If the target is a worshiper of Lythandia or Albion or a wanted criminal, the damage is 2d6.  If the target is not “deserving” bad things happen to the wielder. Additionally, the wielder begins to slowly go blind, but gains blindsight to 30'. The user’s alignment becomes permanently Lawful, though they remain good or neutral as they were previously.  This does not change back if they become un-attuned to the sword. Bad things will happen to the wielder if they commit crimes and are deserving of Justice for it. The wielder gains a compulsion to right wrongs, and to bring the guilty to justice for their crimes. If the wielder wishes, they are able to become an Avatar of Justice.  Doing so enables the following things: The wielder can immediately ‘respec’ their character, and can exchange 3 or more levels already earned into one of the following 3: Clerics of Abadara in the Order domain, Warlocks with a Hexblade Patron and a Pact of the Blade, Paladins with an Oath of Vengeance. Any stat requirements are included, so Str, Wis, or Chr all raise to 13 if they were less than that previously. The powers of the sword will change as appropriate to the class changes that are made. Once the change is made, it is permanent and cannot be changed or altered again short of divine intervention or a Wish.  If the levels themselves are removed via those means, it should be assumed that Abadara will not be pleased.  At all.  This includes becoming an Oathbreaker Paladin. Further advancement in levels after the change are not restricted in any way.",
/*	descriptionLong // OPTIONAL //
	...
	so use the Printer Friendly sheets to test if the description fits.
*/
	descriptionFull : "+3 Bastard Sword of Badassary.",
...
*/
	...
	*/
	/*	descriptionChange : ["prefix", "weapon"],
